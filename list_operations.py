...
input_list = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
...
# print(replace_third_and_last(input_list))    
...
# print(replace_middle(input_list))
...
#     input_list[2:3] = []
#     input_list[5:6] = []
# print(delete_third_and_seventh(input_list))
